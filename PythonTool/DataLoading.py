...
def plane_slice_plotting(window_number, axis_number, images):
    """
...
def data_loading(geometry_file, data_file, images):
   ...
   plane_slice_plotting(2, 2, images)

   # Create the third plot of the XZ plane slice.
   plane_slice_plotting(3, 1, images)

   # Create the fourth plot of the YZ plane slice.
   plane_slice_plotting(4, 0, images)
